...
namespace SpringCaching.Parsing
{
    ...
    public class ExpressionToken
    {
        ...
        /// </summary>
        public static readonly ExpressionToken True = new("1");
        /// <summary>
        /// Canonical false value. Actual value is numerical "0".
        /// </summary>
        public static readonly ExpressionToken False = new("0");
        ...
        private RawToken? _rawToken; // the raw token that makes this token
